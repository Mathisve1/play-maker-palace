...
export const SignupEmail = ({
  ...
  <Html lang="nl" dir="ltr">
    <Head />
    <Preview>Bevestig je e-mailadres — De 12e Man</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        />
        <Heading style={h1}>Welkom bij De 12e Man! 🎉</Heading>
        <Text style={text}>
          Bedankt voor je registratie! Bevestig je e-mailadres ({recipient}) door op de knop hieronder te klikken.
        </Text>
